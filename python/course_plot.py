...
# --- 1. Γράφημα: Κατακόρυφο Bar Chart (ΑΠΟΛΥΤΗ ΕΝΑΡΜΟΝΙΣΗ ΜΕ ΕΚΦΩΝΗΣΗ) ---
...
# Στοίχιση των ονομάτων στον άξονα Χ με σωστή κλίση (rotation) για τέλεια ανάγνωση
...
# --- 3. Γράφημα: Καθαρό Line Plot (ΑΠΟΛΥΤΗ ΕΝΑΡΜΟΝΙΣΗ ΜΕ ΕΚΦΩΝΗΣΗ) ---
